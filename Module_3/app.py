...
# ---------------------------------------------------------------------------
# Configuration — use variables (not hardcoded literals scattered everywhere)
# ---------------------------------------------------------------------------
DB_NAME = "postgres"
DB_USER = "postgres"
...
# ---------------------------------------------------------------------------
app = Flask(__name__)
app.secret_key = os.urandom(24).hex()       # needed for flash messages
...
def background_scrape():
    ...
    try:
        # -- Import scrape module (user must copy scrape.py into Module_3) --
